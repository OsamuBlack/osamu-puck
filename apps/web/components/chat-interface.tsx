...
//   schema,
// } from "@/app/(dashboard)/dashboard/puck/puck.config";
...
//     return btoa(text); // Simple encoding for now
//   },
...
//   // Store API key in localStorage with simple encoding
//   saveApiKey(provider: AIProvider, key: string): void {
//     localStorage.setItem(`${provider}-api-key`, this.encrypt(key));
//   },

//   // Get API key from localStorage and decrypt
//   getApiKey(provider: AIProvider): string {
//     const encrypted = localStorage.getItem(`${provider}-api-key`);
//     if (!encrypted) return "";
...
//     if (geminiKey) {
//       setIsApiKeySet(true);
//       genAIRef.current = new GoogleGenerativeAI(geminiKey);
//       return;
//     }
...
//       secureStorage.saveApiKey("gemini", storedKey);
//       localStorage.removeItem("ai-api-key");
//       setIsApiKeySet(true);
//       genAIRef.current = new GoogleGenerativeAI(storedKey);
//     }
//   }, []);
...
//           explanationMessage =
//             "✅ I've created a layout based on your request. You can review the JSON or apply it directly to the editor.";
...
//   const saveApiKey = () => {
//     if (apiKey.trim()) {
//       // Save to the secure storage system
//       secureStorage.saveApiKey("gemini", apiKey);
//       setIsApiKeySet(true);
...
//     secureStorage.removeApiKey("gemini");
